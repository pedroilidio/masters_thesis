...
\begin{enumerate}
    ...
    They have a small number of hyperparameters in comparison to other algorithms such as deep neural networks, which makes them easy to use and tune~\cite{zhou2019deepa}. % TODO cite more
