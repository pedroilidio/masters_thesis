...
\begin{enumerate}
    \item \textbf{Can bipartite trees be faster?} Is it possible to exploit the bipartite nature of the problem to achieve a speedup in the training of decision trees?
