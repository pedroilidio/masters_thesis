...
\begin{figure}[tb]
    ...
    \caption{
        ...
        Independent two-sample t-tests comparing the slope estimates reveal that the time complexity of \model{bdt-bgso} is highly significantly lower than \model{bdt-gmo} ($p < 10^{-64}$) and even \model{bxt-sq} ($p < 10^{-20}$), and also that \model{bxt-gso} significantly exhibits lower complexity than \model{bxt-sq} ($p < 10^{-22}$).
...
%, including those employing label impuation by NRLMF and those grown with semi-supervised impurities.
