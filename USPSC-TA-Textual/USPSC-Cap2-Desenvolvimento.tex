...
%
$\mathcal{D}$ can then be represented by a set of matrices: $\mathcal{D} = (X_1,\; X_2,\;Y)$, where $X_1\el{ij}=\x\el{j}_{1,i}$, $X_2\el{ij}=\x\el{j}_{2,i}$, and $Y\el{ij}=y_{i,j}$.
...
\begin{figure*}[tbh]
    ...
    \caption{
        ...
        See \autoref{sec:exp settings} for further description of the evaluation procedure. Source: made by the authors.
    }
