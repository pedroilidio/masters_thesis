...
LL, TL, LT, and TT were already presented with similar names by \cite{schrynemackers2015classifying}\cite{pliakos2018} and \cite{pliakos2020drugtarget}. %TODO other previous paper before schrynemackers2015
The authors call them $L_r \times L_c$, $T_r \times L_c$, and so on.
\cite{pahikkala2015more,more} denotes LL-U, LT, TL and TT as C1, C2, C3 and C4, respectively.
\cite{liu2016neighborhood} uses the same notation as \cite{pahikkala2015more} but uses C4 to designate LL-M instead of LL-U. % TODO CHECK
%
...
Using LL-M is more common for matrix factorization methods~\cite{}.
