...
Additionally, we hypothesize that the AP metric could be less sensitive than AUROC to this ability of discovering missing positives \autoref{sec:comparing auroc aupr}, which explains why AUROC does not show the same pattern as AP in the LT+TL setting.
