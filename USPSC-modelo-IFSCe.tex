...
\documentclass[
%draft, 				% [TODO] para compilar mais rápido, remover na versão final
...
\usepackage[num, abnt-emphasize=bf, abnt-thesis-year=both, abnt-repeated-author-omit=no, abnt-last-names=abnt, abnt-etal-list=3, abnt-etal-text=it, abnt-and-type=e, abnt-doi=doi, abnt-url-package=none, abnt-verbatim-entry=no]{abntex2cite} 
...
\bibliographystyle{USPSC-classe/revised-abntex2-numeng-USPSC}  % Pedro's revised version to match SBI IFSC review.
...
\hypersetup{
	...
	pdfkeywords={Desicion forests}{Interaction prediction}{Bipartite learning}{Positive-unlabeled learning}, 
...
%\bibliography{USPSC-bib/bibliography}
\bibliography{USPSC-bib/parsed_bibliography}
