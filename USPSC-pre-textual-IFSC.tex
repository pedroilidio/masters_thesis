...
\titulo{On bipartite decision forests}

\titleabstract{On bipartite decision forests}
\tituloresumo{Florestas de decisão bipartidas}
\autor{Pedro de Carvalho Braga Il\'idio Silva}
\autorficha{Silva, Pedro de Carvalho Braga Il\'idio}
\autorabr{SILVA, P. C. B. I.}
...
\orientador{Prof. Dr. Otavio Henrique Thiemann}
%\orientadorcorpoficha{orientador Otavio Henrique Thiemann}
%\orientadorficha{Thieman, Otavio Henrique, orient}
...
\coorientador{Prof. Dr. Ricardo Cerri}
\orientadorcorpoficha{orientador Otavio Henrique Thiemann ;  co-orientador Ricardo Cerri}
%\orientadorficha{Rodrigues, Elisa Gon\c{c}alves, orient. II. Serqueira, Jo\~ao Alves, co-orient}
\orientadorficha{Thiemann, Otavio Henrique, orient. II. Cerri, Ricardo, co-orient}
